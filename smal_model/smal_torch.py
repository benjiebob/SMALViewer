...
class SMAL(nn.Module):
    def __init__(self, pkl_path, shape_family_id=-1, dtype=torch.float):
        ...
        v_template = get_smal_template(model_name='data/my_smpl_00781_4_all.pkl', data_name='data/my_smpl_data_00781_4_all.pkl', shape_family_id=shape_family_id)
        v, self.left_inds, self.right_inds, self.center_inds = align_smal_template_to_symmetry_axis(v_template, sym_file='data/symIdx.pkl')
